...
import image1 from '@/assets/images/yunus.webp';
export default function Testimonials() {
    const testimonials: Testimonial[] = [
        {
          img: image1,
          quote: "Sure Deed made my land document process so easy and quick!",
          name: 'Rahim Ahmed',
          role: 'Acme LTD'
        },
        {
          img: image1,
          quote: "I never thought getting legal documents could be this convenient.",
          name: 'Salma Begum',
          role: 'Malika Inc.'
        },
        // {
...
interface Testimonial {
  ...
  export function FancyTestimonialsSlider({ testimonials }: { testimonials: Testimonial[] }) {
    ...
    return (
      <div className="w-2/3 mb-12 max-w-screen-sm md:w-full md:max-w-3xl mx-auto text-center">
        <h2 className="mt-12 mb-4 text-3xl font-extrabold leading-tight text-gray-900">Testimonials</h2>
        {/* Testimonial image */}
          ...
          <div className="relative flex flex-col" ref={testimonialsRef}>
            ...
            {testimonials.map((testimonial, index) => (
              <Transition
                ...
                beforeEnter={() => heightFix()}
              >
                <div className="text-sm h-12 md:text-2xl font-bold text-slate-900 before:content-['\201C'] after:content-['\201D']">{testimonial.quote}</div>
              </Transition>
            ))}
